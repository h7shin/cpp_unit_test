...
VOID NAMESPACEfileexample::example_test_1() {
    int x, y;
    NAMESPACE::file_io_emulator fe("examples/example1.input",
                                   "examples/example1.output",
                                   "examples/example1.ref");
    while(std::cin >> x >> y) {
...
VOID NAMESPACEfileexample::example_test_2() {
    int x, y;
    NAMESPACE::file_io_emulator fe("examples/example2.input",
                                   "examples/example2.output",
                                   "examples/example2.ref");
    while(std::cin >> x >> y) {
        std::cout <<add(x, y) << std::endl;
    }
    //std::cout <<add(1,0) << std::endl;
